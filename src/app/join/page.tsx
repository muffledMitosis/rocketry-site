      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16" style={{ viewTransitionName: 'page-content' }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6" style={{ viewTransitionName: 'page-title' }}>
              Join ANU Rocketry
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            <div className="bg-slate-800/60 backdrop-blur-sm rounded-xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-slate-700/50">
          ...
          <div className="mb-12 sm:mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {[
                ...
                <div key={team.name} className="bg-slate-800/60 backdrop-blur-sm rounded-lg p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-slate-700/50">
